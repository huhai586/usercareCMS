import {SAVE_TEMPLATE,GET_ALL_PROJECTS_LIST,GET_CATEGORYS,SEARCH_FAQ,CHANGE_FAQ_DISPLAY,DELETE_MODELS,DELETE_PROJECT,ADD_PROJECT,ADD_MODELS} from '../constants/actions';
